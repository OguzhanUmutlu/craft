...
| **`craft-cli`** | [`crates/cli/`](../crates/cli) | Main CLI entrypoint, 34 command handlers including `optimize`, `modpack`, `autoscale`, `hibernate`, full-screen interactive TUI dashboard, virtual scrolling console with 16 KB chunked seek reader and inside-the-box anchored command prompt. |
